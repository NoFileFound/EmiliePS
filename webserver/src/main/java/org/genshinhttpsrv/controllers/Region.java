...
import org.genshinhttpsrv.api.enums.SubChannelType;
import org.genshinhttpsrv.libraries.EncryptionManager;
import org.genshinhttpsrv.libraries.JsonLoader;
import org.genshinhttpsrv.properties.configs.RegionConfig;
import org.springframework.web.bind.annotation.*;

// Protocol buffers
import org.genshinhttpsrv.protobuf.ForceUpdateInfoOuterClass.ForceUpdateInfo;
import org.genshinhttpsrv.protobuf.QueryCurrRegionHttpRspOuterClass.QueryCurrRegionHttpRsp;
import org.genshinhttpsrv.protobuf.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp;
import org.genshinhttpsrv.protobuf.RegionInfoOuterClass.RegionInfo;
import org.genshinhttpsrv.protobuf.RegionSimpleInfoOuterClass.RegionSimpleInfo;
import org.genshinhttpsrv.protobuf.ResVersionConfigOuterClass.ResVersionConfig;
import org.genshinhttpsrv.protobuf.StopServerInfoOuterClass.StopServerInfo;
...
public final class Region {
        ...
        try {
            this.queryAllRegionResponse = Base64.getEncoder().encodeToString(
                    QueryRegionListHttpRsp.newBuilder()
                            ...
                            .setClientSecretKey(ByteString.copyFrom(EncryptionManager.getDispatchSeed()))
                            .setClientCustomConfigEncrypted(ByteString.copyFrom(EncryptionManager.performXor(JsonLoader.toJson(Application.getRegionInfo().custom_config).getBytes(), EncryptionManager.getDispatchKey())))
    ...
    public Object SendQueryRegionList(String version, Integer lang, ClientType platform, Boolean binary, Integer time, ChannelType channel_id, SubChannelType sub_channel_id, HttpServletRequest request) {
        ...
        return (binary) ? this.queryAllRegionResponse.getBytes() : this.queryAllRegionResponse;
    }
