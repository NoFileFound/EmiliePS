...
public final class Abtest implements Response {
    ...
    /**
     *  Source: <a href="https://abtest-api-data.mihoyo.com/data_abtest_api/config/experiment/list">https://abtest-api-data.mihoyo.com/data_abtest_api/config/experiment/list</a><br><br>
     *  Description: Fetches the scene's experiments.<br><br>
     *  Method: POST<br>
     ...
     *          <li>{@code uid} — The client's user id.</li>
    ...
    public ResponseEntity<LinkedHashMap<String, Object>> SendExperimentList(@RequestBody ExperimentListModel body, @RequestHeader(value = "x-rpc-language", required = false) String lang) {
        ...
        return ResponseEntity.ok(this.makeResponse(Retcode.RETCODE_SUCC, "", DBUtils.findAllExperiments(body.scene_id)));
    }
