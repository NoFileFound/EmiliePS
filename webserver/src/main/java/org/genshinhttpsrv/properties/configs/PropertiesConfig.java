...
public final class PropertiesConfig implements Property {
    ...
    public void loadFile() {
        ...
        if(this.propertiesInstance == null) {
            this.propertiesInstance = new PropertiesClass();
            Application.getLogger().warn(Application.getTranslationManager().get("console", "failedtoinitfile", "properties.json"));
        }
    }
    ...
    public static class PropertiesClass {
        ...
        public JsonNode firebase_blacklist_devices = JsonLoader.parseJsonSafe("[]");
        ...
        public JsonNode bbs_auth_login_ignore = JsonLoader.parseJsonSafe("[]");
        public boolean hoyolab_auth_login = false;
        public JsonNode hoyolab_auth_login_ignore = JsonLoader.parseJsonSafe("[]");
        public boolean enable_age_gate = false;
        public JsonNode enable_age_gate_ignore = JsonLoader.parseJsonSafe("[]");
        public ArrayList<String> thirdparty = new ArrayList<>();
        public JsonNode thirdparty_ignore = JsonLoader.parseJsonSafe("{}");
        public JsonNode thirdparty_login_configs = JsonLoader.parseJsonSafe("{}");
        public JsonNode functional_switch_configs = JsonLoader.parseJsonSafe("{}");
        public AdultLogoOptions logo_eighteenplus = new AdultLogoOptions();
        public JsonNode porte_cn_config = JsonLoader.parseJsonSafe("{ \"downgrade\": true, \"disabledVersionsBelow\": 9, \"disabledDeviceModels\": [ \"cloud\", \"arm64\", \"bilibili\", \"tap\", \"ido\", \"tianyiyun\"] }");
        ...
        public static class ComboConfig {
            ...
            public JsonNode oaid_expire_time = JsonLoader.parseJsonSafe("{\"huawei\":6000,\"honor\":6000}");
            public JsonNode bili_pay_cancel_strings = JsonLoader.parseJsonSafe("[\"用户取消交易\"]\n");
            ...
            public JsonNode kibana_pc_config = JsonLoader.parseJsonSafe("{ \"enable\": 1, \"level\": \"Info\", \"modules\": [\"download\"] }");
            public JsonNode network_report_config = JsonLoader.parseJsonSafe("{ \"enable\": 1, \"status_codes\": [], \"url_paths\": [\"/dataUpload\",\"combo/postman/device/setAlias\"] }");
            public JsonNode h5log_filter_config = JsonLoader.parseJsonSafe("{\n\t\"function\": {\n\t\t\"event_name\": [\"info_get_cps\", \"notice_close_notice\", \"info_get_uapc\", \"report_set_info\", \"info_get_channel_id\", \"info_get_sub_channel_id\"]\n\t}\n}");
            public JsonNode report_black_list = JsonLoader.parseJsonSafe("{ \"key\": [\"download_update_progress\"] }");
        }
        ...
        public static class SwitchStatus {
            ...
            public JsonNode ui_v2_disabled_versions = JsonLoader.parseJsonSafe("[]");
            public boolean enable_apple_login = true;
            public JsonNode apple_login_disabled_versions = JsonLoader.parseJsonSafe("[]");
            public boolean enable_password_reset_entry = true;
            public JsonNode password_reset_entry_disabled_versions = JsonLoader.parseJsonSafe("[]");
            public boolean enable_vn_real_name_v2 = false;
            public JsonNode vn_real_name_v2_disabled_versions = JsonLoader.parseJsonSafe("[]");
            public boolean enable_common_question_entry = true;
            public JsonNode common_question_entry_disabled_versions = JsonLoader.parseJsonSafe("[]");
            public boolean enable_pwd_login_tab = true;
            public JsonNode pwd_login_tab_disabled_versions = JsonLoader.parseJsonSafe("[]");
            public boolean enable_vn_real_name = false;
            public JsonNode vn_real_name_disabled_versions = JsonLoader.parseJsonSafe("[]");
            public boolean enable_firebase_return_unmasked_email = false;
            public JsonNode firebase_return_unmasked_email_disabled_versions = JsonLoader.parseJsonSafe("[]");
            public boolean enable_google_login = true;
            public JsonNode google_login_disabled_versions = JsonLoader.parseJsonSafe("[]");
            public boolean enable_bind_user_thirdparty_email = true;
            public JsonNode bind_user_thirdparty_email_disabled_versions = JsonLoader.parseJsonSafe("[]");
            public boolean enable_third_party_bind_email = true;
            public JsonNode third_party_bind_email_disabled_versions = JsonLoader.parseJsonSafe("[]");
            public boolean enable_bind_thirdparty = false;
            public JsonNode bind_thirdparty_disabled_versions = JsonLoader.parseJsonSafe("[]");
            public boolean enable_user_name_bind_email = true;
            public JsonNode user_name_bind_email_disabled_versions = JsonLoader.parseJsonSafe("[]");
            public boolean enable_account_register_tab = true;
            public JsonNode account_register_tab_disabled_versions = JsonLoader.parseJsonSafe("[]");
            public boolean enable_twitter_login = true;
            public JsonNode twitter_login_disabled_versions = JsonLoader.parseJsonSafe("[]");
            public boolean enable_facebook_login = true;
            public JsonNode facebook_login_disabled_versions = JsonLoader.parseJsonSafe("[]");
            public boolean enable_marketing_authorization = true;
            public JsonNode marketing_authorization_disabled_versions = JsonLoader.parseJsonSafe("[]");
        }
    }
}