package org.emilieps.database.collections;
...
public final class Account {
     ...
     */
    public Account(String emailAddress, String password, String ipAddress, String country_code, Boolean is_guest, String device_id) {
        this._id = DBManager.getCounterValue("lastAccountId");
        this.playerId = -1L;
        this.name = "";
    ...
    public String generateGameToken() {
        this.gameToken = EncryptionManager.generateRandomKey(20);
        this.save();
