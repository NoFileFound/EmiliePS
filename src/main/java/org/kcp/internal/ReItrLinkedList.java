 ...
 */
public class ReItrLinkedList<E> extends AbstractSequentialList<E> implements List<E>, Deque<E>, Cloneable, java.io.Serializable {
    ...
    public ReItrLinkedList<E> reversed() {
        ReItrLinkedList<E> rev = new ReItrLinkedList<>();
