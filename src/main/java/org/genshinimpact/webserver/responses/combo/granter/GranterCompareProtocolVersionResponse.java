...
public class GranterCompareProtocolVersionResponse {
    public Boolean modified;
    public Protocol protocol;

    public GranterCompareProtocolVersionResponse() {
        this.modified = false;
        this.protocol = null;
    }

    public GranterCompareProtocolVersionResponse(Boolean modified, Integer id, AppId app_id, String language, Integer major, Integer minimum) {
